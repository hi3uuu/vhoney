#!/bin/bash
# vHoney Container Data Cleaner & Log Rotator
# Set colors
myRED="[0;31m"
myGREEN="[0;32m"
myWHITE="[0;0m"
...
fuLOGROTATE () {
  local mySTATUS="/opt/vhoney/etc/logrotate/status"
  local myCONF="/opt/vhoney/etc/logrotate/logrotate.conf"
...
chown vhoney:vhoney $myADBHONEYTGZ $myCOWRIETTYTGZ $myCOWRIEDLTGZ $myDIONAEABITGZ $myDIONAEABINTGZ $myHONEYTRAPATTACKSTGZ $myHONEYTRAPDLTGZ $myTANNERFTGZ
...
chown vhoney:vhoney $myADBHONEYDL $myCOWRIETTYLOGS $myCOWRIEDL $myDIONAEABI $myDIONAEABIN $myHONEYTRAPATTACKS $myHONEYTRAPDL $myTANNERF
...
fuADBHONEY () {
  ...
  chown vhoney:vhoney /data/adbhoney/ -R
}
...
fuCISCOASA () {
  ...
  chown vhoney:vhoney /data/ciscoasa -R
}
...
fuCITRIXHONEYPOT () {
  ...
  chown vhoney:vhoney /data/citrixhoneypot/ -R
}
...
fuCONPOT () {
  ...
  chown vhoney:vhoney /data/conpot -R
}
...
fuCOWRIE () {
  ...
  chown vhoney:vhoney /data/cowrie -R
}
...
fuDICOMPOT () {
  ...
  chown vhoney:vhoney /data/dicompot -R
}
...
fuDIONAEA () {
  ...
  chown vhoney:vhoney /data/dionaea -R
}
...
fuELASTICPOT () {
  ...
  chown vhoney:vhoney /data/elasticpot -R
}
...
fuELK () {
  ...
  chown vhoney:vhoney /data/elk -R
}
...
fuFATT () {
  ...
  chown vhoney:vhoney -R /data/fatt
}
...
fuGLUTTON () {
  ...
  chown vhoney:vhoney /data/glutton -R
}
...
fuHERALDING () {
  ...
  chown vhoney:vhoney /data/heralding -R
}
...
fuHONEYPY () {
  ...
  chown vhoney:vhoney /data/honeypy -R
}
...
fuHONEYSAP () {
  ...
  chown vhoney:vhoney /data/honeysap -R
}
...
fuHONEYTRAP () {
  ...
  chown vhoney:vhoney /data/honeytrap/ -R
}
...
fuMAILONEY () {
  ...
  chown vhoney:vhoney /data/mailoney/ -R
}
...
fuMEDPOT () {
  ...
  chown vhoney:vhoney /data/medpot/ -R
}
...
fuRDPY () {
  ...
  chown vhoney:vhoney /data/rdpy/ -R
}
...
fuSPIDERFOOT () {
  ...
  chown vhoney:vhoney -R /data/spiderfoot
}
...
fuSURICATA () {
  ...
  chown vhoney:vhoney -R /data/suricata
}
...
fuP0F () {
  ...
  chown vhoney:vhoney -R /data/p0f
}
...
fuTANNER () {
  ...
  chown vhoney:vhoney -R /data/tanner
}
